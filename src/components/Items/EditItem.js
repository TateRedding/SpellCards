                        ...
                        <form onSubmit={updateItem} autoComplete="off">
                            <div className="form-floating">
                                <input
                                    ...
                                    id="item-name"
                                    aria-labelledby="edit-item-name-taken"
                                    value={name}
                                    required
                                    placeholder="Name"
                            ...
                            <div className="form-text mb-3" id="edit-item-name-taken">
                                {
                                    (nameTaken) ?
                            ...
                            <div className="form-floating">
                                <textarea
                                    className="form-control"
                                    id="item-description"
                                    aria-labelledby="edit-item-description-help-text"
                                    style={{ height: "100px" }}
                                    value={description}
                                    required
                            ...
                            <div className="form-text mb-3" id="edit-item-description-help-text">
